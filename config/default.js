...
module.exports = {
  ...
  auth: {
    token: {
      secret: "JZlYbuhV4MkpG2NzR4gULfUiibdSKpboFav5K4Ge9TEQcs6pDOCPVG3OuYIVCpkrynqaNsC4rtcvOBxjxXlMMQ=="
    },
    local: {},
    facebook: {
  ...
  authEmails: {
    ...
    subs: {
      ...
      productName: '[great-big-angular2-example]',
      productUrl: '[http://great-big-angular2-example.herokuapp.com]',
      senderName: '[Great Big Example Sender]',
      fromEmail: '[Great Big Example <great-big-example@gmail00.com>]',
      supportEmail: '[Starter Support <great-big-example@gmail00.com>]',
